...
$this->title = '班级统计-上线分数';
$this->blocks['requireModule']='app/classes/online_score';
?>
<div class="main col1200 clearfix online_score" id="requireModule" rel="app/classes/online_score">
                    ...
                    <div class="tabItem">
                        <div class="echarts_item">
                            ...
                            <div class="sUI_pannel">
                                <div class="pannel_r">
                                    <select id="grade_select" data-id="<?php echo $examId?>" classId="<?=$classId?>">
