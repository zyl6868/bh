...
$this->blocks['requireModule']='app/classes/name_list';
?>
<div class="main col1200 clearfix name_list" id="requireModule" rel="app/classes/name_list">

    <div class="container  no_bg">
        <div class="item">
            <a href="<?php echo Url::to(['/classstatistics/default/index','classId' => $classId]) ?>"
        ...
        <div class="item no_bg echarts_bar">
            <div class="sUI_tab">
                <?php echo $this->render("@app/modules/classstatistics/views/default/options_list", ['examId' => $examId,'classId' => $classId]); ?>
                <div class="tabCont">
...
<script type="text/javascript">
    ...
    function updateView() {
       ...
       var  examId=<?=$examId?>;
        var classId = <?=$classId?>;
        var selclassId = Number($('#classId').val());
