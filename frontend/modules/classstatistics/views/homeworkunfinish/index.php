...
<div class="main col1200 clearfix statistic_index" id="requireModule" rel="app/classes/class_work_excellent">
    <div class="aside col260 no_bg  alpha">
        ...
        <?php echo $this->render("_homeworkstatistics_left_list",['classId'=>$classId])?>
    ...
    <div class="container col910 no_bg  omega">
        <div class="item sel_test_bar">
            <div class="sUI_tab">
                <ul class="tabList clearfix" style="background: #fff">
                    <li><a href="<?php echo Url::to(['homeworkunfinish/index','classId'=>$classId])?>" class="ac">班级作业统计</a></li>
                </ul>
            </div>
        </div>
        ...
        <div id="answerPage" style="background:white" class="pd25 answerPage">
                    ...
                    <div class="row">
                        ...
                        <div class="form_r" style="margin-left:55px;">
                            <ul class="testList clearfix" id="select_month" data-url="<?= url::to('index',['classId'=>$classId]);?>">
                                ...
                                <li><a data-sel-item href="javascript:;" class="<?php if(date("m",strtotime($firstDay))  == $month){echo 'sel_ac';} ?>" data-value="<?= $month ?>" ><?= $month ?>月</a></li>
                                <?php }?>
                            </ul>
                        </div>
                    </div>
            ...
            <div id="statistics">
                <?php echo $this->render('_index_info',['subjectArr'=>$subjectArr ,'finishArr'=>$finishArr , 'unfinishArr'=>$unfinishArr]);?>
            </div>
