        ...
        <div class="item sel_test_bar">
            <div id="time_tab" class="sUI_tab">
                <ul class="tabList clearfix" style="background: #fff">
                    <li><a href="<?php echo Url::to(["/classstatistics/classshortboard/index",'classId'=>$classId]);?>" class="ac">月短板</a></li>
                ...
                <div class="tabCont">
                    <div class="tabItem selector clearfix">
                        <div class="gnn_tabCon">
                            <label>学科：</label>
                            <select id="subject_select" classId="<?= $classId?>">
                            ...
                            <label>月份：</label>
                            <input readonly="readonly" class="text0" placeholder="点击选择月" value="<?php echo $defaultYearMonth?>">
