	...
	<div class="tch_question container col910 omega no_bg">
		<div class="container" style="margin-top:0">
			<div class="sUI_pannel collections">
				<div class="pannel_l">
					<a href="javascript:;" class="sel_ac" data-sel-item>我的创建</a>
				</div>
			</div>
			<div class="pd25">
				<div class="sUI_formList sUI_formList_min classes_file_list">
					<div id="classes_sel_list" class="row" de="<?php echo $department ?>"
					     sub="<?php echo $subjectId ?>">
						<?php
						//纸质作业和电子作业筛选项
						echo $this->render("_teacher_paper_or_electronic_nav");
						?>
					</div>
				</div>
			</div>
