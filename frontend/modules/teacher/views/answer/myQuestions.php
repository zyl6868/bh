...
$this->title = "我的提问";
$this->blocks['requireModule'] = 'app/teacher/answer_questions';
...
<div class="main clearfix col1200 classes_answering_question">
	<div class="container col910 alpha no_bg">
		...
		<div id="classes_sel_list"  class="container no_bg">
				<ul id="question_state" class="question_state classes_file_list" style="padding-top:10px;padding-bottom: 12px;">
					<li id="state1" data-id="1" class="">
						<a class="is_solved sel_ac" data-sel-item href="javascript:;">全部状态</a>
					</li>
					<li id="state3" data-id="3" >
						<a class="is_solved" data-sel-item href="javascript:;" solved_type="1">
							<i class="already_processed"></i>已解决</a>

					</li>
					<li id="state4" data-id="4" >
						<a class="is_solved" data-sel-item href="javascript:;" solved_type="2">
							<i class="waiting_reply"></i>未解决</a>
					</li>
				</ul>
			<div class="check_answer_list">
				<?php
			echo $this->render('//publicView/answer/_my_question_list',['modelList' => $modelList, 'pages' => $pages])?>
			</div>
		</div>
