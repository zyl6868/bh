...
<div id="main" class="main">
    <h4 id="main_head" class="bg_fff main_head"><a href="javascript:;" onclick="javascript:history.back(-1)" class="btn icoBtn_back"><i></i>返回</a>发布通知</h4>

    <div class="bg_fff" style="padding-top:23px;">
        <div class="gap" id="gap">
            <span class="width_left lineH" id="lineH" name="HomeContactForm[title]"><i class="red">*</i>通知标题:</span>

            <div class="write_pen title__txt" id="title__txt">
                <i></i>请在这里输入通知标题
            </div>
            ...
            <!--                <div id="Remind_message"><span>123</span></div>-->
            <span id="max_length"></span>
        </div>
        <!-- 收件人 -->
                ...
                <?php foreach ($schoolClass as $class) { ?>
                    <ul class="ul_1">
                        <li class="border__" id="<?php echo $class->classID; ?>">
                            <span><label><input name="grade_class" type="radio"/><?php echo $class->className; ?>
                                </label></span>
                        </li>
                        <li class="user_hide">
                            <select class="choose" name="HomeContactForm[scope]">
                                <option value="1">全部学生</option>
                                <option value="0">部分学生</option>
                            </select>
                        </li>
        ...
        <div class="gap">
            ...
            <label><input name="receiverType" value="1" type="checkbox" id="stu">学生</label>&nbsp;&nbsp;
            <label><input name="receiverType" value="2" type="checkbox" id="parents">家长</label>
        </div>
        <!-- 通知内容 -->
        <div style="position:relative">
            <span class="width_left"><i class="red">*</i>通知内容:</span><textarea
                                                                               name="HomeContactForm[addContent]"></textarea>
            <span
        ...
        <div class="btn_class">
            <button type="button" class="btn send" id="send" value="send">立即发送</button>
            <button type="button" class="btn save" id="save" value="save">保存</button>
        </div>
    </div>
</div>
