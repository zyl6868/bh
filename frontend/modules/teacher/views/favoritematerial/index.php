...
<div class="main col1200 clearfix platform_question_bank" id="requireModule" rel="app/teacher/teacher_home_courseware">
            ...
            <div class="pannel_l">
                <div class="sUI_tab">
                    <ul class="tabList clearfix">
                        <li><a href="<?php echo Url::to(["/teacher/resources/collect-work-manage"]) ?>"
                               class="tch_hmwk_ic"><i></i>作业</a></li>
                        <li><a href="<?php echo Url::to(["/teacher/question/index"]) ?>" class="tch_question_ic"><i></i>题目</a>
                        </li>
                        <li><a href="<?php echo Url::to(["/teacher/favoritematerial/index"]) ?>"
                               class="tch_courseware_ic ac"><i></i>课件</a></li>
                        <li><a href="<?php echo Url::to(["/teacher/managepaper/index"]) ?>" class="tch_exam_ic"><i></i>试卷</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="aside col260 alpha no_bg">
        <ul class="custom_toggle">
            <li class="collection"><a
                    href="<?php echo Url::to(['/teacher/favoritematerial/index', 'department' => $department, 'subjectId' => $subjectId]) ?>"
                    class="<?php echo $groupType == 0 ? 'ac' : '' ?>">我的收藏</a></li>
        </ul>
        <div id="groupList">
            <?php echo $this->render('_group_list', ["department" => $department, "subjectId" => $subjectId, 'groupType' => $groupType,
                'customGroupArray' => $customGroupArray, 'groupId' => $groupId,'defaultGroupId'=>$defaultGroupId,'groupDefaultArray'=>$groupDefaultArray])?>
        </div>
    </div>

    <div id="material_list">
        <?php
        echo $this->render('_index_list_favorite', $arr);
        ?>
    </div>
...
<!--删除课件-->
<div id="delCourse" class="popBox hide delCourse" title="删除组">
    <div class="popCont clearfix">
        <div class="ico"><i></i></div>
