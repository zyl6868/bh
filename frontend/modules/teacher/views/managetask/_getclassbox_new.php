                    ...
                    if(code){
                        ...
                        $.post($form_id.attr('action'), $form_id.serialize(),function(data){
                            ...
                            if(data.success){
                                ...
                                window.location.href="/teacher/resources/collect-work-manage";
                            }else{
...
<div class="popBtnArea">
    <div class="share_work" style="position: absolute;line-height: 2.2em;margin-left: 5em;">
        <?php if(isset($getType) && $getType==1){?>
        <input type="checkbox" name="isShare" value="1" id="isShare">共享到平台作业库
        <?php }?>
        <?php if(isset($homeworkTeaOne->getType) && $homeworkTeaOne->getType==1){?>
