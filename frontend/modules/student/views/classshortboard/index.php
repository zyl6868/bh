    ...
    <div class="aside col260 no_bg  alpha">
        <div class="asideItem">
            <div class="sel_classes">
                <div class="pd15">
                    <h5 style="text-indent:10px;">短板池</h5>
        ...
        <div class="item sel_test_bar">
            <div id="time_tab" class="sUI_tab">
                <ul class="tabList clearfix" style="background: #fff">
                    <li><a href="<?php echo Url::to(["/student/classshortboard/index"]);?>" class="ac">月短板</a></li>
                    <li><a href="<?php echo Url::to(["/student/classshortboard/week-short"]);?>">周短板</a></li>
                </ul>
                <div class="tabCont">
                    <div class="tabItem selector clearfix">
                        <div class="gnn_tabCon">
                            ...
                            <label>月份：</label>
                            <input readonly="readonly" class="text0" placeholder="点击选择月" value="<?php echo date('Y-m',strtotime($firstDay))?>">
