...
?>
<div class="main col1200 clearfix add_memorabilia" id="requireModule" rel="app/classes/classes_memorabilia_modify">
            ...
            <div class="new_tch_group add_memor_popbox">
                ...
                <div class="sUI_formList">
                    <div class="row">
                        ...
                        <div class="form_r">
                            <input id="memor_name" type="text" name="<?php echo Html::getInputName($eventModel, 'name') ?>"  value="<?php echo $eventModel->eventName?>" class="text validate[required,maxSize[30]]" data-prompt-position="topLeft"  style="width:75%">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form_l">
                        ...
                        <div class="form_r">
                            <input type="text" type="text" name="<?php echo Html::getInputName($eventModel, 'time') ?>"  value="<?php echo date('Y-m-d',$eventModel->time/1000)?>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'<?php echo date('Y-m-d h:i:s',time())?>'})"  class="text validate[required]" data-prompt-position="topLeft"   >
                        </div>
                    </div>
                    <div class="row">
                        <div class="form_l">
                        ...
                        <div class="form_r">
                            <textarea style="width:75%; height:120px"  class="text validate[maxSize[1000]]"  name="SeClassEvent[briefOfEvent]"><?php echo $eventModel->briefOfEvent ?></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form_l">
                                ...
                                <ul class="clearfix picList">
                                    <?php $url=$eventModel->eventPic;
                                     ...
                                     if($url!=null){
                                         ...
                                         ?>
                                         <li>
                                             <input type="hidden" value="<?php echo $v->picUrl?>" name="SeClassEvent[image][]">
                                             <img alt="" src="<?php echo resCdn($v->picUrl) ?>">
...
<script>
        ...
        $.each(data.result, function (index, file) {
            ...
            $('<li><input type="hidden" name="SeClassEvent[image][]" value="'+file.url+'"><img src="'+file.url+'" alt=""><span class="delBtn"></span></li>').insertBefore('.uploadFile');
