    ...
    $.validationEngineLanguage = {
        newLang:function(){
            $.validationEngineLanguage.allRules = {
                ...
                "checkPhoneNumber":{
                    "url": "/ajax/check-phone-num",
                    "alertText": "此手机已被其他人使用",
                    "alertTextLoad": "正在验证手机号，请稍等。"
                },
                "checkVerifycode":{
                    "url": "/ajax/check-verifycode",
                    "extraData":"phoneNum="+$('#phoneNum').val(),
                    "alertText": "验证码不正确",
                    "alertTextLoad": "正在验证验证码，请稍等。"
                },
                "checkLoginName":{
                    "url": "/ajax/check-login-name",
                    "alertText": "此登录名已经被注册",
                    "alertTextLoad": "正在验证登录名，请稍等。"
                },
                "ajaxPhoneNumber": {
                    "url": "/Ajax/CheckPhone",
                    // error
