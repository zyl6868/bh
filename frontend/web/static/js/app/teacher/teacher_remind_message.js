define(['jquery', 'popBox', 'jqueryUI', 'validationEngine', 'validationEngine_zh_CN', 'jquery_sanhai'], function ($, popBox, jqueryUI, jquery_sanhai, validationEngine, validationEngine_zh_C) {
    $("#tab li").click(function () {
        ...
        var homeworkType = $(this).attr('data-messageType');
        $.get("/teacher/message/quality-work", {homeworkType: homeworkType}, function (data) {
    ...
    $(document).on('click', '#caution .okBtn', function () {
        ...
        $.get("/teacher/message/delete-notice", {id: messageId}, function (data) {
            if (data.success) {
                elePars.remove();
