...
namespace schoolmanage\components\behaviors;
 ...
 * @since 2.0
 */
class ControllerAttributeBehavior extends AttributeBehavior
{
    /**
     * @var string the attribute that will receive timestamp value
     * Set this property to false if you do not want to record the creation time.
     */
    public $attribute='schoolModel';
    ...
    public function init()
    {
        ...
        if (empty($this->attributes)) {
            $this->attributes = [
                Controller::EVENT_BEFORE_ACTION => [$this->attribute],
            ];
        }
    }
    ...
    protected function getValue($event)
    {
        ...
        if ($this->value instanceof Expression) {
            ...
            return $this->value !== null ? call_user_func($this->value, $event) : null;
        }
    }
