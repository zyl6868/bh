...
$this->blocks['requireModule']='app/sch_mag/sch_mag_input_half';
?>
    <div class="main col1200 clearfix sch_mag_input" id="requireModule" rel="app/sch_mag/sch_mag_input_half">
        ...
        <div class="container">
            <div class="pd25">
                ...
                <?php echo  $this->render('_public_score',['status'=>1])?>
                <hr>
                <div id="editCont" class="edit_input editCont">
