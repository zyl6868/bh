...
$this->blocks['bodyclass'] = "personnel";

$this->registerCssFile(BH_CDN_RES.'/static/css/sch_mag.css'.RESOURCES_VER);
$this->registerJsFile(BH_CDN_RES.'/static/js/lib/echarts/echarts.js'.RESOURCES_VER );
...
<div class="class_nav col1200">
    ...
    <ul class="class_nav_list clearfix">
        ...
        <li class="<?php echo $this->context->highLightUrl(['personnel/teacher/index', 'personnel/student/index','personnel/student/no-class-students']) ? 'ac' : ''?>">
