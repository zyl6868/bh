...
const httpConfig = {
  ceshi: '/courseware/v3?token={"uid":"202534","token":"c537c8af-ccc7-4f46-9751-bfeec4f3b969"}&vp=courseware', // ceshi
  ...
  keywordsAll: '/keywords/homework-and-material', // 搜索全部
  keywordsMaterial: '/keywords/material-list', // 搜索课件教案
  keywordsHomework: '/keywords/homework-list' // 搜索精品作业
}
