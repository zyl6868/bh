...
/**
 * This is the model class for table "se_exam_scoreInput".
 *
 * @property integer $tempScoreId 临时表个人成绩主键id
 * @property integer $classExamId 班级考试id
 * @property string $userName 用户名称（用户表中）
 * @property string $userNameInput 用户名称（excel中）
 ...
 */
class SeExamScoreInput extends PosActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['userName', 'userNameInput'], 'string', 'max' => 20]
        ];
    }
    ...
    {
        return [
            'tempScoreId' => '临时表个人成绩主键id',
            'classExamId' => '班级考试id',
            'userName' => '用户名称（用户表中）',
            'userNameInput' => '用户名称（excel中）',
            'userId' => '用户id（用户表中）',
            'sub10010' => '语文',
            'sub10011' => '数学',
            'sub10012' => '英语',
    ...
    /**
     * @inheritdoc
     * @return SeExamScoreInputQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new SeExamScoreInputQuery(get_called_class());
    }
}
