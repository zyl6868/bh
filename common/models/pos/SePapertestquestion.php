...
/**
 * This is the model class for table "se_papertestquestion".
 *
 * @property integer $paperQuesId
 * @property integer $id
 ...
 */
class SePapertestquestion extends PosActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return SePapertestquestionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new SePapertestquestionQuery(get_called_class());
    }
    ...
    {
        return [
            [['paperQuesId', 'id'], 'required'],
            [['paperQuesId', 'id', 'childnum'], 'integer'],
